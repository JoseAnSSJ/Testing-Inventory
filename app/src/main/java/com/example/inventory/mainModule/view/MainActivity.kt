...
import com.example.inventory.addModule.view.AddProductFragment
import com.example.inventory.databinding.ActivityMainBinding
import com.example.inventory.entities.Product
import com.example.inventory.mainModule.view.adapters.OnClickListener
import com.example.inventory.mainModule.view.adapters.ProductAdapter
...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        val msg = when(item.itemId){
            R.id.action_history -> getString(R.string.main_accion_text)
            else -> getString(R.string.main_accion_text_exit)
        }
